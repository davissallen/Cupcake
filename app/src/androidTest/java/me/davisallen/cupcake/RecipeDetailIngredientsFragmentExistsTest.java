...
public class RecipeDetailIngredientsFragmentExistsTest {
    ...
    public void recipeDetailIngredientsFragmentExists() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.ingredients_list_title), withText("Ingredients"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction recyclerView3 = onView(
                allOf(withId(R.id.fragment_ingredients_recycler_view),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.fragment_container_details),
                                        0),
